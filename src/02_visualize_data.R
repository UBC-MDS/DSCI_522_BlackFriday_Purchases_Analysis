...
create_gender_barplot <- function(data){
  ...
  temp <-
    ...
    ggtitle("Black Friday purchases made by female and male") +
    theme_bw() +
...
create_purch_hist <- function(data){
  ...
  temp <-
    ...
    ylab("Number of Purchase Orders") +
    ggtitle("The distribution of Black Friday purchases") +
    theme_bw() +
    theme(plot.title = element_text(size = 13, face = "bold", hjust = 0.5))
...
create_gender_pur_hist <- function(data){
  ...
  temp <-
    ...
    xlab("Purchase Amount") + 
    ylab("Number of Purchase Orders") +
    ggtitle("The distribution of Black Friday purchases by gender") +
    theme_bw() +
    theme(plot.title = element_text(size = 13, face = "bold", hjust = 0.5))
